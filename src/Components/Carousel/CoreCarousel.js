            ...
            <div className='hidden lg:block w-full'>
                <Slider {...settingLg}>
                    <div className='w-[500px] h-[500px] rounded-full relative inline-flex'>
                        ...
                        <div className='absolute top-0 bg-[#1E40AF] text-white w-[500px] h-[500px] rounded-full bg-opacity-[40%]  p-4'>
                            <h1 className='text-center font-bold text-2xl'>Integrity</h1>
                            <p className='text-center text-xl mt-10'>We are committed to the highest standards of quality in every dish we create and every service we provide.</p>
                        </div>
                    </div>
                    <div className='w-[500px] h-[500px] rounded-full relative inline-flex'>
