        ...
        >
          <div className='absolute top-0 w-full h-full bg-[#00ADEF] bg-opacity-[50%] font-Mons'>
            <div className='absolute bottom-[5%] md:bottom-[15%] lg:bottom-[25%] left-[4%]'>
              ...
              <p className='text-gray-200 text-sm md:w-[60%]'>Transform your vision into a spectacular reality with our bespoke catering and event planning services, where every detail is crafted to perfection, ensuring your event is as unique and memorable as you are</p>
            </div>
          </div>
        </section>
        <section className='bg-[#135A70] w-[95%] mx-auto mt-[100px] md:flex justify-center items-center gap-3 p-4 mb-10'>
          ...
          <div className='basis-[55%] bg-white p-3 mt-5'>
            <form action="https://api.web3forms.com/submit" method="POST">
              ...
              <select id="package" className='w-full md:w-[300px] py-2 px-2 mt-3'>
              ...
              <div className='flex flex-wrap gap-5'>
                ...
                <div className='text-md font-["Inter"]'>
                  ...
                  <textarea type="text" name='description' placeholder='Describe Your Event...' rows="6" className='bg-[#F5F2FB] p-2 block w-full md:w-[400px]' required/>
                </div>
              </div>
